...
  selectedCount, onDelete, onDuplicate, onExport, onAssignReferrer, onClearSelection, isLoading = false,
...
    { label: 'Eliminar', icon: Trash2, onClick: onDelete, destructive: true },
  ];
...
                size="icon"
                disabled={isLoading}
                className={`hidden md:inline-flex ${ACTION_BUTTON_CLASSES} hover:bg-destructive/10 hover:text-destructive`}
              >
                <X className="w-4 h-4" />
              </Button>
            </TooltipTrigger>
