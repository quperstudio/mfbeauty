...
  // MUTACIÓN 4: DUPLICAR CLIENTE (Usando función de base de datos)
  const duplicateMutation = useMutation({
    mutationFn: async (clientId: string) => {
      // Llama a una función RPC para duplicar cliente y sus etiquetas asociadas
...
      return data as Client;
    },
    // Invalida la lista para mostrar el nuevo cliente duplicado
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: QUERY_KEYS.clients.all });
    },
  });

  // MUTACIÓN 5: ASIGNAR REFERENTE (Masivo)
